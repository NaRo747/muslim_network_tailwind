...
const Navbar = () => {
  ...
  return (
    <nav className="w-full flex py-6 justify-between items-center navbar">
      <img src={logo} alt="muslimNetwork" className="w-[32px] h-[32px]"/>
      <h1 className="sm:flex hidden ml-3 text-white text-[20px] font-poppins font-normal">MuslimNetwork</h1>
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center">
        ...
        <div 
          className={`${toggle ? 'flex' : 'hidden'}
           p-6 bg-green-gradient absolute top-20
